...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="{{ asset('clients/assets/imgs/template/favicon.svg') }}">
    <link href="{{ asset('clients/assets/css/stylecd4e.css?version=4.1') }}" rel="stylesheet">
    ...
    <div id="preloader-active">
      <div class="preloader d-flex align-items-center justify-content-center">
        <div class="preloader-inner position-relative">
          <div class="text-center"><img src="{{ asset('clients/assets/imgs/template/loading.gif') }}" alt="jobBox"></div>
        </div>
      </div>
    </div>
  ...
  @include('clients.components.footer')
    ...
    <script src="{{ asset('clients/assets/js/vendor/modernizr-3.6.0.min.js') }}"></script>
    <script src="{{ asset('clients/assets/js/vendor/jquery-3.6.0.min.js') }}"></script>
    <script src="{{ asset('clients/assets/js/vendor/jquery-migrate-3.3.0.min.js') }}"></script>
    <script src="{{ asset('clients/assets/js/vendor/bootstrap.bundle.min.js') }}"></script>
    <script src="{{ asset('clients/assets/js/plugins/waypoints.js') }}"></script>
    <script src="{{ asset('clients/assets/js/plugins/wow.js') }}"></script>
    <script src="{{ asset('clients/assets/js/plugins/magnific-popup.js') }}"></script>
    <script src="{{ asset('clients/assets/js/plugins/perfect-scrollbar.min.js') }}"></script>
    <script src="{{ asset('clients/assets/js/plugins/select2.min.js') }}"></script>
    <script src="{{ asset('clients/assets/js/plugins/isotope.js') }}"></script>
    <script src="{{ asset('clients/assets/js/plugins/scrollup.js') }}"></script>
    <script src="{{ asset('clients/assets/js/plugins/swiper-bundle.min.js') }}"></script>
    <script src="{{ asset('clients/assets/js/plugins/counterup.js') }}"></script>
    <script src="{{ asset('clients/assets/js/main8c94.js?v=4.1') }}"></script>
  </body>
